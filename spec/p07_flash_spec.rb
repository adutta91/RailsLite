...
describe Phase7::Flash do
  let(:req) { Rack::Request.new(Logger: nil) }
  let(:res) { WEBrick::HTTPResponse.new(HTTPVersion: '1.0') }
  let(:cook) do
    Rack::Session::Cookie.new('_rails_lite_app_flash', { xyz: 'abc' }.to_json)
  end
